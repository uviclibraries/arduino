...
To use the IDE for Arduino development, you could use the desktop versions supporting  Windows, Linux and Mac, please go to the Arduino website and [download the "Arduino IDE"](https://www.arduino.cc/en/Main/Software){:target="_blank"} for either Windows or Mac, and then install the software on your computer.
The other option is to use the cloud editor based on browser which would be even simpler.


1.  Using the provided USB cable plug your Arduino into your computer.
